...
# --- Specialist Agent Discovery and API Configuration ---
...
# Then print and use _client_agent_instruction
...
# --- Tool Definitions ---
# ... (fetch_agent_card, start_session_with_specialist, delegate_task_with_session tools as defined before) ...
# Ensure these tool definitions are also above the Agent definition if they are referenced somehow,
# though only their names are passed to the Agent constructor usually.
...
# --- ADK Agent and Runner Definition ---
root_agent = Agent(
